...
export const systems: System[] = [
  ...
  },
  {
    ...
    subtitle: 'A course marketplace: creators, subscriptions and certificates',
    tagline: 'A multi-creator academy on the commerce rails: learners start free, buy once or subscribe; creators publish and get paid.',
    description:
      'A course marketplace built on the same commerce rails: a course is a product, so it sells through the existing cart, wallet and order pipeline rather than a parallel payment stack. Creators run their own studio to build curriculum, price and promote courses and get paid; learners get a player that resumes where they left off, graded tests and a certificate anyone can verify. Each tenant’s academy carries its own look and editable page copy, separate from its shop.',
    ...
    features: [
      'Three ways in: free, buy once, or subscribe — to the whole academy or to a single creator’s plan',
      'Lessons mix hosted video (YouTube, Vimeo) with self-hosted uploads, sanitized rich-text articles and downloadable attachments',
      'A player that resumes at the last position, with notes, captions, Q&A and an optional no-skip-ahead policy',
      'Drip scheduling, practice tests, and graded tests that gate the certificate alongside full completion',
      'Certificates with editable templates, public verification by code and a social share card',
      'Creator Studio: revenue with CSV export, creator-funded coupons, announcements and learner messaging',
      'Catalog with topics, filters, ratings, wishlists and a public instructor directory with live stats',
      'Moderation built in: content reports, a review queue, and account archival instead of deletion',
    ],
    highlights: [
      'Edits to a live course are held, not published: learners keep the approved version until a reviewer accepts the change from a before/after comparison.',
      ...
      'A refund reverses the wallet debit, the creator’s credit and the enrollment in one transition, and the creator platform fee is snapshotted at checkout so past payouts stay reproducible.',
    ],
    techStack: ['TypeScript', 'Fastify', 'PostgreSQL', 'React', 'S3-compatible storage'],
    heroImage: {
      src: '/systems/learning-home.webp',
      alt: 'The academy home: headline, live course, mentor and learner counts, and the topic-filtered catalog',
      width: 1600,
      height: 1000,
    },
    gallery: [
      {
        src: '/systems/learning-home.webp',
        alt: 'Academy home with hero, live stats and the filterable course catalog',
        caption:
          'The academy home: its own theme, CMS-editable copy, and stats computed with the same rules as the catalog below it.',
        width: 1600,
        height: 1000,
      },
      {
        src: '/systems/learning-course.webp',
        alt: 'Course page with curriculum, instructor profile, preview and purchase panel',
        caption: 'A course page: curriculum, instructor and a free preview beside the buy, cart and save actions.',
        width: 1600,
        height: 740,
      },
      {
